...
const emailVerificationMailgenContent = (username, verificationUrl) => {
    return {
        body: {
            ...
            outro: "Need help, or have questions? just reply to this email, we'h love to help.",
        },
    };
};
...
const forgotPasswordMailgenContent = (username, passwordResetUrl) => {
  return {
    body: {
      ...
      outro:
        "Need help, or have questions? just reply to this email, we'h love to help.",
    },
  };
};
